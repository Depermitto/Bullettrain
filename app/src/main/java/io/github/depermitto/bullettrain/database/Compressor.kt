...
object Compressor {
  /**
   * Compress data using gzip and encode with base64. This is equivalent to using `echo string |
   * gzip | base64 > file`
   */
  ...
  /**
   * Decompress base64-encoded gzipped data. This is equivalent to using `base64 -d file | gunzip`
   */
  @OptIn(ExperimentalEncodingApi::class)
