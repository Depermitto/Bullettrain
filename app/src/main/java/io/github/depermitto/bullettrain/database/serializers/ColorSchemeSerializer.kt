...
object ColorSchemeSerializer : KSerializer<ColorScheme> {
    ...
    override fun serialize(encoder: Encoder, value: ColorScheme) = encoder.encodeSerializableValue(
        SerializableColorScheme.serializer(), SerializableColorScheme(
    ...
    override fun deserialize(decoder: Decoder): ColorScheme {
        val serializableColorScheme = decoder.decodeSerializableValue(SerializableColorScheme.serializer())
        return ColorScheme(
