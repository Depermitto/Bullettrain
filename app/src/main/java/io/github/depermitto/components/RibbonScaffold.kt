...
import io.github.depermitto.home.Screen.SettingsScreen
...
fun BoxScope.Ribbon(
    ...
    if (settingsGear) {
        IconButton(modifier = Modifier.align(Alignment.TopEnd), onClick = { navController.navigate(SettingsScreen.route) }) {
